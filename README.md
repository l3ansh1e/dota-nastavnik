...
Дота-Наставник бесплатный и таким останется. Если он тебе зашёл и хочется, чтобы проект развивался — впереди баны в драфте, уровни сложности бота и режим «угадай контрпик» — можно закинуть на кофе: **[DonationAlerts](https://www.donationalerts.com/r/l3ansh1e)**
