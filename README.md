...
**[Скачать установщик](https://github.com/l3ansh1e/dota-nastavnik/releases/latest)** (77 МБ). Ставится в один клик, без прав администратора, ярлык появится на рабочем столе. При первом запуске Windows может показать предупреждение SmartScreen — нажми «Подробнее» → «Выполнить в любом случае».
...
Дота-Наставник бесплатный и таким останется. Если он тебе зашёл и хочется, чтобы проект развивался (впереди баны в драфте, уровни сложности бота и режим «угадай контрпик»), то можешь поддержать проект: **[DonationAlerts](https://www.donationalerts.com/r/l3ansh1e)**

Любая сумма — мотивация пилить дальше)
